# Awesome GLP-1 Resources 🩺 💉

[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/Jarvis322/awesome-glp1-resources/pulls)
[![Haftra GLP-1 Tracker](https://img.shields.io/badge/Haftra-GLP--1%20Tracker-coral?style=flat&logo=apple&logoColor=white)](https://haftra.app)

> A curated list of scientific research, medication guides, pharmacokinetic calculators, 6-zone injection site rotation maps, and dose tracking applications for GLP-1 and GIP/GLP-1 receptor agonist therapies (Mounjaro, Ozempic, Wegovy, Zepbound, Saxenda, and next-generation molecules).
...
GLP-1 (Glucagon-Like Peptide-1) and GIP (Glucose-Dependent Insulinotropic Polypeptide) receptor agonists mimic endogenous incretin hormones to delay gastric emptying, regulate appetite, and improve glycemic control.

| Brand Name | Active Molecule | Target Receptors | Standard Dosing Cycle | Manufacturer | Primary Indications |
|---|---|---|---|---|---|
| **Mounjaro®** | Tirzepatide | GIP / GLP-1 dual agonist | Weekly (7-day) | Eli Lilly | Type 2 Diabetes (Off-label / approved for weight management in various regions) |
| **Zepbound®** | Tirzepatide | GIP / GLP-1 dual agonist | Weekly (7-day) | Eli Lilly | Chronic Weight Management |
| **Ozempic®** | Semaglutide | GLP-1 receptor agonist | Weekly (7-day) | Novo Nordisk | Type 2 Diabetes |
| **Wegovy®** | Semaglutide | GLP-1 receptor agonist | Weekly (7-day) | Novo Nordisk | Chronic Weight Management, CV risk reduction |
| **Saxenda®** | Liraglutide | GLP-1 receptor agonist | Daily (24-hour) | Novo Nordisk | Chronic Weight Management |
| **Rybelsus®** | Semaglutide | GLP-1 receptor agonist | Daily oral tablet | Novo Nordisk | Type 2 Diabetes |
| *Retatrutide* (Investigational) | Retatrutide | GIP / GLP-1 / Glucagon triple | Weekly | Eli Lilly | Phase 3 TRIUMPH Program |
| *CagriSema* (Investigational) | Cagrilintide + Semaglutide | Amylin / GLP-1 dual | Weekly | Novo Nordisk | Phase 3 REDEFINE Program |
| *Orforglipron* (Investigational) | Orforglipron | Oral non-peptide GLP-1 | Daily oral | Eli Lilly | Phase 3 ATTAIN Program |
...
2. **Left Abdomen:** Symmetric opposite zone.
3. **Right Anterior Thigh:** Front outer quadrant of the thigh.
4. **Left Anterior Thigh:** Symmetric opposite leg.
...
## 📊 Pharmacokinetics & Plasma Level Modeling

GLP-1 and GIP receptor agonists possess distinct pharmacokinetic profiles dictated by albumin binding, fatty acid acylation, and subcutaneous depot absorption:

- **Tirzepatide (Mounjaro/Zepbound):** Elimination half-life ($t_{1/2}$) is approximately **5 days** (120 hours). Peak plasma concentration ($C_{\max}$) typically occurs between **24 to 48 hours** (Days 2–3) post-injection. Steady-state is achieved after 4 weeks of weekly dosing.
- **Semaglutide (Ozempic/Wegovy):** Elimination half-life ($t_{1/2}$) is approximately **7 days** (168 hours). Peak concentration occurs between **24 to 72 hours**. Steady-state is reached in 4 to 5 weeks.
...
## 🥗 Nutrition, Hydration & Muscle Preservation

Rapid adiposity loss without structured nutritional intervention risks **sarcopenia** (loss of lean skeletal muscle mass) and gallstone formation.

- **Protein Threshold:** Minimum 1.2 g to 1.6 g per kilogram of reference body weight daily to preserve lean tissue.
- **Hydration:** Minimum 2.5–3.0 liters of fluids daily, especially on pharmacokinetic peak absorption days (Days 2–3) to mitigate GLP-1 induced nausea and orthostatic hypotension.
- **Dietary Texture:** Small, frequent, nutrient-dense portions; avoidance of hyperosmolar, high-fat meals that aggravate delayed gastric emptying.

---

## 🛡️ Medical Disclaimers

This repository is for educational, scientific reference, and technological tracking purposes only. 
- It does **not** constitute medical advice, diagnosis, prescription, or therapeutic recommendations.
- All pharmacological interventions, dosage titrations, and medication selections must be conducted under the direct supervision of a licensed endocrinologist or physician.
- Haftra and referenced tools are lifestyle and dose-logging companions; they are not medical diagnostic devices.

---

## 🤝 Contributing

Contributions, additions of newly published peer-reviewed clinical trials, and open-source health tools are welcome! Please open an issue or submit a pull request following the contribution guidelines.

---

**Maintained by:** [Jarvis322](https://github.com/Jarvis322) & [Haftra Health Technologies](https://haftra.app)  
**Official Website:** [https://haftra.app](https://haftra.app)
